...
| 19 | Regime, durability, momentum, atau dynamic structure memisahkan remaining L4+ | Schema v3 observation-only; uji compact core plus satu family per experiment | Zero-L4 gate tercapai tanpa retained/active-day gate rusak | Rejected; all five staged challengers retain 28-41 evaluation L4+ |
...
| 2026-07-24 | Entry feature schema v3, folders 47/48 | Reject every staged runtime challenger; retain artifacts for research only | Audit retains 1,080/1,080 including all 101 L4+; core/volatility/durability/momentum/structure all fail zero-L4, with 28-41 evaluation L4+ still allowed | Diagnose features against L4 depth directly before proposing another entry filter |
